 ...
 * @param {number} timezone Timezone shift from UTV in seconds
...
export const aqiText = {
  ...
  4: {
    level: 'Poor',
    message: 'Everyone may begin to experience heath affects; members of sensitive groups may experience more serious health effects.'
  },
  5: {
    level: 'Very Poor',
