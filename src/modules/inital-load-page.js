export default function loadPageStructure(){
  ...
  // Number of list items you want to create
  const numberOfWindItems = 24; // Change this to the number of items you need
  ...
  const errorHomeLink = document.createElement('p');
  errorHomeLink.href = '#';
  errorHomeLink.classList.add('btn-primary');
  errorContent.appendChild(errorHomeLink);

  const errorHomeSpan = document.createElement('p');
